...
async function convertSvgToPng() {
  ...
  const svgPath = path.resolve(__dirname, "diagrama_completo.svg");
  ...
  await page.setViewport({
    ...
    deviceScaleFactor: 3, // para alta resolução
  ...
  const outputPath = path.resolve(__dirname, "diagrama_completo_puppeteer.png");
